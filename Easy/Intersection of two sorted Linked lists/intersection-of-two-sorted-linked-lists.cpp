...
class Solution
{
    ...
    {
        //we have given that the new list should be made without changing the orignal list
        //so we have take the new list
        ...
        while(head1 &&head2){
            ///there are 3 cases 
            //case 1.when the values of both the list are equal
